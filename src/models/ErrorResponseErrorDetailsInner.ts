 ...
 * 
 * @export
 * @interface ErrorResponseErrorDetailsInner
 */
export interface ErrorResponseErrorDetailsInner {
    /**
     * 
     * @type {string}
     * @memberof ErrorResponseErrorDetailsInner
     */
    field?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ErrorResponseErrorDetailsInner interface.
 */
export function instanceOfErrorResponseErrorDetailsInner(value: object): value is ErrorResponseErrorDetailsInner {
    return true;
}

export function ErrorResponseErrorDetailsInnerFromJSON(json: any): ErrorResponseErrorDetailsInner {
    return ErrorResponseErrorDetailsInnerFromJSONTyped(json, false);
}

export function ErrorResponseErrorDetailsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ErrorResponseErrorDetailsInner {
    if (json == null) {
        return json;
    }
    return {
...
export function ErrorResponseErrorDetailsInnerToJSON(json: any): ErrorResponseErrorDetailsInner {
    return ErrorResponseErrorDetailsInnerToJSONTyped(json, false);
}

export function ErrorResponseErrorDetailsInnerToJSONTyped(value?: ErrorResponseErrorDetailsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
