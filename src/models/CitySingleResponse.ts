 ...
 * 
 * @export
 * @interface CitySingleResponse
 */
export interface CitySingleResponse {
    /**
     * 
     * @type {City}
     * @memberof CitySingleResponse
     */
    data?: City;
}

/**
 * Check if a given object implements the CitySingleResponse interface.
 */
export function instanceOfCitySingleResponse(value: object): value is CitySingleResponse {
    return true;
}

export function CitySingleResponseFromJSON(json: any): CitySingleResponse {
    return CitySingleResponseFromJSONTyped(json, false);
}

export function CitySingleResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CitySingleResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : CityFromJSON(json['data']),
    };
}

export function CitySingleResponseToJSON(json: any): CitySingleResponse {
    return CitySingleResponseToJSONTyped(json, false);
}

export function CitySingleResponseToJSONTyped(value?: CitySingleResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
