...
/**
 * Check if a given object implements the RegionRef interface.
 */
export function instanceOfRegionRef(value: object): value is RegionRef {
    return true;
}

export function RegionRefFromJSON(json: any): RegionRef {
    return RegionRefFromJSONTyped(json, false);
}

export function RegionRefFromJSONTyped(json: any, ignoreDiscriminator: boolean): RegionRef {
    if (json == null) {
        return json;
    }
    return {
...
export function RegionRefToJSON(json: any): RegionRef {
    return RegionRefToJSONTyped(json, false);
}

export function RegionRefToJSONTyped(value?: RegionRef | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
