 ...
 * 
 * @export
 * @interface BoundarySingleResponse
 */
export interface BoundarySingleResponse {
    /**
     * 
     * @type {Boundary}
     * @memberof BoundarySingleResponse
     */
    data?: Boundary;
}

/**
 * Check if a given object implements the BoundarySingleResponse interface.
 */
export function instanceOfBoundarySingleResponse(value: object): value is BoundarySingleResponse {
    return true;
}

export function BoundarySingleResponseFromJSON(json: any): BoundarySingleResponse {
    return BoundarySingleResponseFromJSONTyped(json, false);
}

export function BoundarySingleResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BoundarySingleResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : BoundaryFromJSON(json['data']),
    };
}

export function BoundarySingleResponseToJSON(json: any): BoundarySingleResponse {
    return BoundarySingleResponseToJSONTyped(json, false);
}

export function BoundarySingleResponseToJSONTyped(value?: BoundarySingleResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': BoundaryToJSON(value['data']),
    };
}
