...
export interface CountrySingleResponse {
     ...
     * 
     * @type {Country}
     * @memberof CountrySingleResponse
     */
    data?: Country;
}

/**
 * Check if a given object implements the CountrySingleResponse interface.
 */
export function instanceOfCountrySingleResponse(value: object): value is CountrySingleResponse {
    return true;
}

export function CountrySingleResponseFromJSON(json: any): CountrySingleResponse {
    return CountrySingleResponseFromJSONTyped(json, false);
}

export function CountrySingleResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountrySingleResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : CountryFromJSON(json['data']),
    };
}

export function CountrySingleResponseToJSON(json: any): CountrySingleResponse {
    return CountrySingleResponseToJSONTyped(json, false);
}

export function CountrySingleResponseToJSONTyped(value?: CountrySingleResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
