...
/**
 * Check if a given object implements the RegionListResponse interface.
 */
export function instanceOfRegionListResponse(value: object): value is RegionListResponse {
    return true;
}

export function RegionListResponseFromJSON(json: any): RegionListResponse {
    return RegionListResponseFromJSONTyped(json, false);
}

export function RegionListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RegionListResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(RegionFromJSON)),
        'meta': json['meta'] == null ? undefined : PaginationMetaFromJSON(json['meta']),
    };
}

export function RegionListResponseToJSON(json: any): RegionListResponse {
    return RegionListResponseToJSONTyped(json, false);
}

export function RegionListResponseToJSONTyped(value?: RegionListResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(RegionToJSON)),
