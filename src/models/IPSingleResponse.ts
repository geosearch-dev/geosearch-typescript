...
import type { IPResult } from './IPResult';
import {
    IPResultFromJSON,
    IPResultFromJSONTyped,
    IPResultToJSON,
    IPResultToJSONTyped,
} from './IPResult';
 ...
 */
export interface IPSingleResponse {
    /**
     * 
     * @type {IPResult}
     * @memberof IPSingleResponse
     */
    data?: IPResult;
}

/**
 * Check if a given object implements the IPSingleResponse interface.
 */
export function instanceOfIPSingleResponse(value: object): value is IPSingleResponse {
    return true;
}

export function IPSingleResponseFromJSON(json: any): IPSingleResponse {
    return IPSingleResponseFromJSONTyped(json, false);
}

export function IPSingleResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IPSingleResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : IPResultFromJSON(json['data']),
    };
}

export function IPSingleResponseToJSON(json: any): IPSingleResponse {
    return IPSingleResponseToJSONTyped(json, false);
}

export function IPSingleResponseToJSONTyped(value?: IPSingleResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': IPResultToJSON(value['data']),
    };
}
