 ...
 * 
 * @export
 * @interface IPResultContinent
 */
export interface IPResultContinent {
    /**
     * 
     * @type {string}
     * @memberof IPResultContinent
     */
    code?: string;
    /**
     * 
...
/**
 * Check if a given object implements the IPResultContinent interface.
 */
export function instanceOfIPResultContinent(value: object): value is IPResultContinent {
    return true;
}

export function IPResultContinentFromJSON(json: any): IPResultContinent {
    return IPResultContinentFromJSONTyped(json, false);
}

export function IPResultContinentFromJSONTyped(json: any, ignoreDiscriminator: boolean): IPResultContinent {
    if (json == null) {
        return json;
    }
    return {
...
export function IPResultContinentToJSON(json: any): IPResultContinent {
    return IPResultContinentToJSONTyped(json, false);
}

export function IPResultContinentToJSONTyped(value?: IPResultContinent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
