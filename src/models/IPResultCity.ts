 ...
 * 
 * @export
 * @interface IPResultCity
 */
export interface IPResultCity {
    /**
     * 
     * @type {string}
     * @memberof IPResultCity
     */
    name?: string;
}

/**
 * Check if a given object implements the IPResultCity interface.
 */
export function instanceOfIPResultCity(value: object): value is IPResultCity {
    return true;
}

export function IPResultCityFromJSON(json: any): IPResultCity {
    return IPResultCityFromJSONTyped(json, false);
}

export function IPResultCityFromJSONTyped(json: any, ignoreDiscriminator: boolean): IPResultCity {
    if (json == null) {
        return json;
    }
    return {
...
export function IPResultCityToJSON(json: any): IPResultCity {
    return IPResultCityToJSONTyped(json, false);
}

export function IPResultCityToJSONTyped(value?: IPResultCity | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
