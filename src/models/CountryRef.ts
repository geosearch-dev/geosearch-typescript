...
/**
 * Check if a given object implements the CountryRef interface.
 */
export function instanceOfCountryRef(value: object): value is CountryRef {
    return true;
}

export function CountryRefFromJSON(json: any): CountryRef {
    return CountryRefFromJSONTyped(json, false);
}

export function CountryRefFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountryRef {
    if (json == null) {
        return json;
    }
    return {
...
export function CountryRefToJSON(json: any): CountryRef {
    return CountryRefToJSONTyped(json, false);
}

export function CountryRefToJSONTyped(value?: CountryRef | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
