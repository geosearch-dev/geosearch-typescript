...
/**
 * Check if a given object implements the CityListResponse interface.
 */
export function instanceOfCityListResponse(value: object): value is CityListResponse {
    return true;
}

export function CityListResponseFromJSON(json: any): CityListResponse {
    return CityListResponseFromJSONTyped(json, false);
}

export function CityListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CityListResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(CityFromJSON)),
        'meta': json['meta'] == null ? undefined : PaginationMetaFromJSON(json['meta']),
    };
}

export function CityListResponseToJSON(json: any): CityListResponse {
    return CityListResponseToJSONTyped(json, false);
}

export function CityListResponseToJSONTyped(value?: CityListResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(CityToJSON)),
