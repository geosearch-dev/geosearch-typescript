 ...
 * 
 * @export
 * @interface IPResultRegion
 */
export interface IPResultRegion {
    /**
     * 
     * @type {string}
     * @memberof IPResultRegion
     */
    isoCode?: string;
    /**
     * 
...
/**
 * Check if a given object implements the IPResultRegion interface.
 */
export function instanceOfIPResultRegion(value: object): value is IPResultRegion {
    return true;
}

export function IPResultRegionFromJSON(json: any): IPResultRegion {
    return IPResultRegionFromJSONTyped(json, false);
}

export function IPResultRegionFromJSONTyped(json: any, ignoreDiscriminator: boolean): IPResultRegion {
    if (json == null) {
        return json;
    }
    return {
...
export function IPResultRegionToJSON(json: any): IPResultRegion {
    return IPResultRegionToJSONTyped(json, false);
}

export function IPResultRegionToJSONTyped(value?: IPResultRegion | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
