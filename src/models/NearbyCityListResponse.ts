...
import type { NearbyCity } from './NearbyCity.js';
import {
    NearbyCityFromJSON,
    NearbyCityFromJSONTyped,
    NearbyCityToJSON,
    NearbyCityToJSONTyped,
} from './NearbyCity.js';

/**
 * 
 * @export
 * @interface NearbyCityListResponse
 */
export interface NearbyCityListResponse {
    /**
     * 
     * @type {Array<NearbyCity>}
     * @memberof NearbyCityListResponse
     */
    data?: Array<NearbyCity>;
    /**
     * 
     * @type {PaginationMeta}
     * @memberof NearbyCityListResponse
...
/**
 * Check if a given object implements the NearbyCityListResponse interface.
 */
export function instanceOfNearbyCityListResponse(value: object): value is NearbyCityListResponse {
    return true;
}

export function NearbyCityListResponseFromJSON(json: any): NearbyCityListResponse {
    return NearbyCityListResponseFromJSONTyped(json, false);
}

export function NearbyCityListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): NearbyCityListResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(NearbyCityFromJSON)),
        'meta': json['meta'] == null ? undefined : PaginationMetaFromJSON(json['meta']),
    };
}

export function NearbyCityListResponseToJSON(json: any): NearbyCityListResponse {
    return NearbyCityListResponseToJSONTyped(json, false);
}

export function NearbyCityListResponseToJSONTyped(value?: NearbyCityListResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(NearbyCityToJSON)),
