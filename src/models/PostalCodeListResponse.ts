...
import type { PostalCode } from './PostalCode.js';
import {
    PostalCodeFromJSON,
    PostalCodeFromJSONTyped,
    PostalCodeToJSON,
    PostalCodeToJSONTyped,
} from './PostalCode.js';

/**
 * 
 * @export
 * @interface PostalCodeListResponse
 */
export interface PostalCodeListResponse {
    /**
     * 
     * @type {Array<PostalCode>}
     * @memberof PostalCodeListResponse
     */
...
/**
 * Check if a given object implements the PostalCodeListResponse interface.
 */
export function instanceOfPostalCodeListResponse(value: object): value is PostalCodeListResponse {
    return true;
}

export function PostalCodeListResponseFromJSON(json: any): PostalCodeListResponse {
    return PostalCodeListResponseFromJSONTyped(json, false);
}

export function PostalCodeListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostalCodeListResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(PostalCodeFromJSON)),
        'meta': json['meta'] == null ? undefined : PaginationMetaFromJSON(json['meta']),
    };
}

export function PostalCodeListResponseToJSON(json: any): PostalCodeListResponse {
    return PostalCodeListResponseToJSONTyped(json, false);
}

export function PostalCodeListResponseToJSONTyped(value?: PostalCodeListResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(PostalCodeToJSON)),
