...
/**
 * Check if a given object implements the SearchListResponse interface.
 */
export function instanceOfSearchListResponse(value: object): value is SearchListResponse {
    return true;
}

export function SearchListResponseFromJSON(json: any): SearchListResponse {
    return SearchListResponseFromJSONTyped(json, false);
}

export function SearchListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchListResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function SearchListResponseToJSON(json: any): SearchListResponse {
    return SearchListResponseToJSONTyped(json, false);
}

export function SearchListResponseToJSONTyped(value?: SearchListResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
