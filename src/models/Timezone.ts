...
export function TimezoneFromJSONTyped(json: any, ignoreDiscriminator: boolean): Timezone {
    ...
    return {
        ...
        'timezoneId': json['timezone_id'] == null ? undefined : json['timezone_id'],
        'gmtOffset': json['gmt_offset'] == null ? undefined : json['gmt_offset'],
        'dstOffset': json['dst_offset'] == null ? undefined : json['dst_offset'],
        'rawOffset': json['raw_offset'] == null ? undefined : json['raw_offset'],
    };
}
