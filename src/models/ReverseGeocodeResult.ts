...
/**
 * Check if a given object implements the ReverseGeocodeResult interface.
 */
export function instanceOfReverseGeocodeResult(value: object): value is ReverseGeocodeResult {
    return true;
}

export function ReverseGeocodeResultFromJSON(json: any): ReverseGeocodeResult {
    return ReverseGeocodeResultFromJSONTyped(json, false);
}

export function ReverseGeocodeResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReverseGeocodeResult {
    if (json == null) {
        return json;
    }
    return {
        
        'city': json['city'] == null ? undefined : NearbyCityFromJSON(json['city']),
        'distanceKm': json['distance_km'] == null ? undefined : json['distance_km'],
    };
}

export function ReverseGeocodeResultToJSON(json: any): ReverseGeocodeResult {
    return ReverseGeocodeResultToJSONTyped(json, false);
}

export function ReverseGeocodeResultToJSONTyped(value?: ReverseGeocodeResult | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'city': NearbyCityToJSON(value['city']),
