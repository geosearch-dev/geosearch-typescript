 ...
 * 
 * @export
 * @interface IPResultPostal
 */
export interface IPResultPostal {
    /**
     * 
     * @type {string}
     * @memberof IPResultPostal
     */
    code?: string;
}

/**
 * Check if a given object implements the IPResultPostal interface.
 */
export function instanceOfIPResultPostal(value: object): value is IPResultPostal {
    return true;
}

export function IPResultPostalFromJSON(json: any): IPResultPostal {
    return IPResultPostalFromJSONTyped(json, false);
}

export function IPResultPostalFromJSONTyped(json: any, ignoreDiscriminator: boolean): IPResultPostal {
    if (json == null) {
        return json;
    }
    return {
...
export function IPResultPostalToJSON(json: any): IPResultPostal {
    return IPResultPostalToJSONTyped(json, false);
}

export function IPResultPostalToJSONTyped(value?: IPResultPostal | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
