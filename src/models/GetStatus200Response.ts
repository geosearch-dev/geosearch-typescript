...
import type { GetStatus200ResponseData } from './GetStatus200ResponseData.js';
import {
    GetStatus200ResponseDataFromJSON,
    GetStatus200ResponseDataFromJSONTyped,
    GetStatus200ResponseDataToJSON,
    GetStatus200ResponseDataToJSONTyped,
} from './GetStatus200ResponseData.js';
...
export interface GetStatus200Response {
    /**
     * 
     * @type {GetStatus200ResponseData}
     * @memberof GetStatus200Response
     */
    data?: GetStatus200ResponseData;
}
...
export function GetStatus200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetStatus200Response {
    ...
    return {
        ...
        'data': json['data'] == null ? undefined : GetStatus200ResponseDataFromJSON(json['data']),
    };
}
...
export function GetStatus200ResponseToJSONTyped(value?: GetStatus200Response | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'data': GetStatus200ResponseDataToJSON(value['data']),
    };
}
